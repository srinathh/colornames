...
// Map contains named colors defined in SVG1.1 spec mapped to color.RGBA values
...
// Names contains the color names defined in SVG1.1 spec in alphabetical order
var Names = []string{
	"aliceblue",
	"antiquewhite",
	"aqua",
